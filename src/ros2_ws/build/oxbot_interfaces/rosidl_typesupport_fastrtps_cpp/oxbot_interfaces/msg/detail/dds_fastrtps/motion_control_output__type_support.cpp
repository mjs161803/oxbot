...
#include "oxbot_interfaces/msg/detail/motion_control_output__rosidl_typesupport_fastrtps_cpp.hpp"
...
{
bool cdr_serialize(
  const oxbot_interfaces::msg::HoverboardFeedback &,
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  // Member: mc_output
  {
    ...
    for (size_t i = 0; i < size; i++) {
      oxbot_interfaces::msg::typesupport_fastrtps_cpp::cdr_serialize(
        ros_message.mc_output[i],
        cdr);
    }
  }
  return true;
  ...
  oxbot_interfaces::msg::MotionControlOutput & ros_message)
{
  // Member: mc_output
  {
    ...
    ros_message.mc_output.resize(size);
    for (size_t i = 0; i < size; i++) {
      oxbot_interfaces::msg::typesupport_fastrtps_cpp::cdr_deserialize(
        cdr, ros_message.mc_output[i]);
    }
  }
  ...
  size_t current_alignment)
{
  ...
  // Member: mc_output
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment +=
        oxbot_interfaces::msg::typesupport_fastrtps_cpp::get_serialized_size(
        ros_message.mc_output[index], current_alignment);
    }
  }
  ...
  size_t current_alignment)
{
  ...
  // Member: mc_output
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      current_alignment +=
        oxbot_interfaces::msg::typesupport_fastrtps_cpp::max_serialized_size_HoverboardFeedback(
...
{
  auto typed_message =
    static_cast<const oxbot_interfaces::msg::MotionControlOutput *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<oxbot_interfaces::msg::MotionControlOutput *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _MotionControlOutput__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const oxbot_interfaces::msg::MotionControlOutput *>(
...
static size_t _MotionControlOutput__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_MotionControlOutput(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _MotionControlOutput__callbacks = {
...
static rosidl_message_type_support_t _MotionControlOutput__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_MotionControlOutput__callbacks,
...
{
  return &oxbot_interfaces::msg::typesupport_fastrtps_cpp::_MotionControlOutput__handle;
}
