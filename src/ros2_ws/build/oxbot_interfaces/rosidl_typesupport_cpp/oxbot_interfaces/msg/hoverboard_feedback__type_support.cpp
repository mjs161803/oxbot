...
static const _HoverboardFeedback_type_support_symbol_names_t _HoverboardFeedback_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, oxbot_interfaces, msg, HoverboardFeedback)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, oxbot_interfaces, msg, HoverboardFeedback)),
  }
};
...
{
  return &::oxbot_interfaces::msg::rosidl_typesupport_cpp::HoverboardFeedback_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, oxbot_interfaces, msg, HoverboardFeedback)() {
  return get_message_type_support_handle<oxbot_interfaces::msg::HoverboardFeedback>();
}
