...
static const _HoverboardCommand_type_support_symbol_names_t _HoverboardCommand_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, oxbot_interfaces, msg, HoverboardCommand)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, oxbot_interfaces, msg, HoverboardCommand)),
  }
};
...
{
  return &::oxbot_interfaces::msg::rosidl_typesupport_cpp::HoverboardCommand_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, oxbot_interfaces, msg, HoverboardCommand)() {
  return get_message_type_support_handle<oxbot_interfaces::msg::HoverboardCommand>();
}
